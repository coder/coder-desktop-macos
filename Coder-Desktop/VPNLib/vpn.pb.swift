...
public struct Vpn_ClientMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var msg: Vpn_ClientMessage.OneOf_Msg? = nil
  ...
  public var status: Vpn_StatusRequest {
    get {
      if case .status(let v)? = msg {return v}
      return Vpn_StatusRequest()
    }
...
public struct Vpn_ServiceMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var msg: Vpn_ServiceMessage.OneOf_Msg? = nil
  ...
  /// either in reply to a StatusRequest or broadcasted
  public var status: Vpn_Status {
    get {
      if case .status(let v)? = msg {return v}
      return Vpn_Status()
    }
...
public struct Vpn_StartRequest: Sendable {
  ...
  public var coderDesktopVersion: String = String()
...
public struct Vpn_StatusRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Vpn_Status: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var lifecycle: Vpn_Status.Lifecycle = .unknown
  ...
  /// be populated.
  public var peerUpdate: Vpn_PeerUpdate {
    get {return _peerUpdate ?? Vpn_PeerUpdate()}
    set {_peerUpdate = newValue}
  }
  /// Returns true if `peerUpdate` has been explicitly set.
  public var hasPeerUpdate: Bool {return self._peerUpdate != nil}
  /// Clears the value of `peerUpdate`. Subsequent reads from it will return its default value.
  public mutating func clearPeerUpdate() {self._peerUpdate = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum Lifecycle: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    case unknown // = 0
    case starting // = 1
    case started // = 2
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Vpn_Status.Lifecycle] = [
      .unknown,
      .starting,
      .started,
      .stopping,
...
extension Vpn_ClientMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .status?: try {
      guard case .status(let v)? = self.msg else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Vpn_ClientMessage, rhs: Vpn_ClientMessage) -> Bool {
    if lhs._rpc != rhs._rpc {return false}
    if lhs.msg != rhs.msg {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Vpn_ServiceMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ServiceMessage"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "rpc"),
    2: .same(proto: "start"),
    3: .same(proto: "stop"),
  ...
  public static func ==(lhs: Vpn_ServiceMessage, rhs: Vpn_ServiceMessage) -> Bool {
    if lhs._rpc != rhs._rpc {return false}
    if lhs.msg != rhs.msg {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Vpn_StartRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "device_os"),
    7: .standard(proto: "coder_desktop_version"),
  ]
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.deviceOs.isEmpty {
      try visitor.visitSingularStringField(value: self.deviceOs, fieldNumber: 6)
    }
  ...
  public static func ==(lhs: Vpn_StartRequest, rhs: Vpn_StartRequest) -> Bool {
    ...
    if lhs.coderDesktopVersion != rhs.coderDesktopVersion {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Vpn_StatusRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Vpn_StatusRequest, rhs: Vpn_StatusRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Vpn_Status: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Status"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "lifecycle"),
    2: .standard(proto: "error_message"),
    3: .standard(proto: "peer_update"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.lifecycle) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.errorMessage) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._peerUpdate) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.lifecycle != .unknown {
      try visitor.visitSingularEnumField(value: self.lifecycle, fieldNumber: 1)
    }
    if !self.errorMessage.isEmpty {
      try visitor.visitSingularStringField(value: self.errorMessage, fieldNumber: 2)
    }
    try { if let v = self._peerUpdate {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Vpn_Status, rhs: Vpn_Status) -> Bool {
    if lhs.lifecycle != rhs.lifecycle {return false}
    if lhs.errorMessage != rhs.errorMessage {return false}
    if lhs._peerUpdate != rhs._peerUpdate {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Vpn_Status.Lifecycle: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
